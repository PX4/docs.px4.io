import{_ as a,c as i,a8 as n,o as t}from"./chunks/framework.BDnHobkS.js";const d=JSON.parse('{"title":"TelemetryStatus (UORB message)","description":"","frontmatter":{},"headers":[],"relativePath":"ko/msg_docs/TelemetryStatus.md","filePath":"ko/msg_docs/TelemetryStatus.md"}'),l={name:"ko/msg_docs/TelemetryStatus.md"};function e(p,s,h,k,E,r){return t(),i("div",null,s[0]||(s[0]=[n(`<h1 id="telemetrystatus-uorb-message" tabindex="-1">TelemetryStatus (UORB message) <a class="header-anchor" href="#telemetrystatus-uorb-message" aria-label="Permalink to &quot;TelemetryStatus (UORB message)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/TelemetryStatus.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint8 LINK_TYPE_GENERIC </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">bool</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> parachute_system_healthy</span></span></code></pre></div>`,3)]))}const _=a(l,[["render",e]]);export{d as __pageData,_ as default};
