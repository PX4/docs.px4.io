import{_ as i,c as n,a8 as a,o as e}from"./chunks/framework.BDnHobkS.js";const c=JSON.parse('{"title":"LedControl (UORB message)","description":"","frontmatter":{},"headers":[],"relativePath":"ko/msg_docs/LedControl.md","filePath":"ko/msg_docs/LedControl.md"}'),t={name:"ko/msg_docs/LedControl.md"};function l(p,s,h,r,o,k){return e(),n("div",null,s[0]||(s[0]=[a(`<h1 id="ledcontrol-uorb-message" tabindex="-1">LedControl (UORB message) <a class="header-anchor" href="#ledcontrol-uorb-message" aria-label="Permalink to &quot;LedControl (UORB message)&quot;">​</a></h1><p>LED control: control a single or multiple LED&#39;s. These are the externally visible LED&#39;s, not the board LED&#39;s</p><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/LedControl.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># LED control: control a single or multiple LED</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;s.</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uint8 ORB_QUEUE_LENGTH = 8      # needs to match BOARD_MAX_LEDS</span></span></code></pre></div>`,4)]))}const d=i(t,[["render",l]]);export{c as __pageData,d as default};
