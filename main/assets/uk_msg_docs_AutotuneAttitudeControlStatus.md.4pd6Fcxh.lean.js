import{_ as i,c as a,a8 as n,o as t}from"./chunks/framework.BDnHobkS.js";const d=JSON.parse('{"title":"AutotuneAttitudeControlStatus (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/AutotuneAttitudeControlStatus.md","filePath":"uk/msg_docs/AutotuneAttitudeControlStatus.md"}'),l={name:"uk/msg_docs/AutotuneAttitudeControlStatus.md"};function e(p,s,h,k,o,r){return t(),a("div",null,s[0]||(s[0]=[n(`<h1 id="autotuneattitudecontrolstatus-повідомлення-uorb" tabindex="-1">AutotuneAttitudeControlStatus (повідомлення UORB) <a class="header-anchor" href="#autotuneattitudecontrolstatus-повідомлення-uorb" aria-label="Permalink to &quot;AutotuneAttitudeControlStatus (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/AutotuneAttitudeControlStatus.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint64 timestamp                # time since system </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (microseconds)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uint8 state</span></span></code></pre></div>`,3)]))}const c=i(l,[["render",e]]);export{d as __pageData,c as default};
