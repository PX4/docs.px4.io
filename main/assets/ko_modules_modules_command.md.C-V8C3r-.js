import{_ as s,c as e,al as n,o as t}from"./chunks/framework.D3pXwl8O.js";const u=JSON.parse('{"title":"모듈 참조: 명령","description":"","frontmatter":{},"headers":[],"relativePath":"ko/modules/modules_command.md","filePath":"ko/modules/modules_command.md"}'),p={name:"ko/modules/modules_command.md"};function l(i,a,r,o,c,d){return t(),e("div",null,a[0]||(a[0]=[n(`<h1 id="모듈-참조-명령" tabindex="-1">모듈 참조: 명령 <a class="header-anchor" href="#모듈-참조-명령" aria-label="Permalink to &quot;모듈 참조: 명령&quot;">​</a></h1><h2 id="bl-update" tabindex="-1">bl_update <a class="header-anchor" href="#bl-update" aria-label="Permalink to &quot;bl_update&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/actuator_test" target="_blank" rel="noreferrer">systemcmds/actuator_test</a></p><p>파일에서 부트로더를 플래시하는 유틸리티</p><p>WARNING: remove all props before using this command.</p><h3 id="actuator_test_usage" tabindex="-1">Usage <a class="header-anchor" href="#actuator_test_usage" aria-label="Permalink to &quot;Usage {#actuator_test_usage}&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>actuator_test &lt;command&gt; [arguments...]</span></span>
...
<span class="line"><span>                 comparison is used if multiple are specified</span></span></code></pre></div>`,179)]))}const m=s(p,[["render",l]]);export{u as __pageData,m as default};
