import{_ as a,c as i,a8 as n,o as e}from"./chunks/framework.BDnHobkS.js";const k=JSON.parse('{"title":"SensorsStatusImu (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/SensorsStatusImu.md","filePath":"uk/msg_docs/SensorsStatusImu.md"}'),t={name:"uk/msg_docs/SensorsStatusImu.md"};function l(r,s,p,c,o,h){return e(),i("div",null,s[0]||(s[0]=[n(`<h1 id="sensorsstatusimu-повідомлення-uorb" tabindex="-1">SensorsStatusImu (повідомлення UORB) <a class="header-anchor" href="#sensorsstatusimu-повідомлення-uorb" aria-label="Permalink to &quot;SensorsStatusImu (повідомлення UORB)&quot;">​</a></h1><p>Метрики перевірки датчика. Це значення буде нульовим для датчика, який є первинним або незаповненим.</p><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/SensorsStatusImu.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">#</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uint8[4] gyro_priority</span></span></code></pre></div>`,4)]))}const u=a(t,[["render",l]]);export{k as __pageData,u as default};
