import{_ as i,c as a,o as n,al as t}from"./chunks/framework.CT7RwC5a.js";const d=JSON.parse('{"title":"HomePosition (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/HomePosition.md","filePath":"uk/msg_docs/HomePosition.md"}'),e={name:"uk/msg_docs/HomePosition.md"};function l(p,s,h,o,k,E){return n(),a("div",null,s[0]||(s[0]=[t(`<h1 id="homeposition-повідомлення-uorb" tabindex="-1">HomePosition (повідомлення UORB) <a class="header-anchor" href="#homeposition-повідомлення-uorb" aria-label="Permalink to &quot;HomePosition (повідомлення UORB)&quot;">​</a></h1><p>Домашнє GPS положення в координатах WGS84.</p><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/versioned/HomePosition.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># GPS home position in WGS84 coordinates.</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">float32 roll				# Pitch angle in radians</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">float32 pitch				# Roll angle in radians</span></span>
