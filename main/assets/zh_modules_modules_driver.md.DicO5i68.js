...
<span class="line"><span>   stop</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   status        print status info</span></span></code></pre></div><h2 id="batmon" tabindex="-1">batmon <a class="header-anchor" href="#batmon" aria-label="Permalink to &quot;batmon&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/drivers/smart_battery/batmon" target="_blank" rel="noreferrer">drivers/smart_battery/batmon</a></p><h3 id="描述-3" tabindex="-1">描述 <a class="header-anchor" href="#描述-3" aria-label="Permalink to &quot;描述&quot;">​</a></h3><p>Driver for SMBUS Communication with BatMon enabled smart-battery Setup/usage information: <a href="https://rotoye.com/batmon-tutorial/" target="_blank" rel="noreferrer">https://rotoye.com/batmon-tutorial/</a></p><h3 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h3><p>To start at address 0x0B, on bus 4</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>batmon start -X -a 11 -b 4</span></span></code></pre></div><h3 id="batmon_usage" tabindex="-1">Usage <a class="header-anchor" href="#batmon_usage" aria-label="Permalink to &quot;Usage {#batmon_usage}&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>batmon &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
<span class="line"><span>   start</span></span>
<span class="line"><span>     [-I]        Internal I2C bus(es)</span></span>
<span class="line"><span>     [-X]        External I2C bus(es)</span></span>
...
<span class="line"><span>   stop</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   status        print status info</span></span></code></pre></div><h2 id="dshot" tabindex="-1">dshot <a class="header-anchor" href="#dshot" aria-label="Permalink to &quot;dshot&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/drivers/dshot" target="_blank" rel="noreferrer">drivers/dshot</a></p><h3 id="描述-5" tabindex="-1">描述 <a class="header-anchor" href="#描述-5" aria-label="Permalink to &quot;描述&quot;">​</a></h3><p>This is the DShot output driver. It is similar to the fmu driver, and can be used as drop-in replacement to use DShot as ESC communication protocol instead of PWM.</p><p>On startup, the module tries to occupy all available pins for DShot output. It skips all pins already in use (e.g. by a camera trigger module).</p><p>It supports:</p><ul><li>DShot150, DShot300, DShot600</li><li>telemetry via separate UART and publishing as esc_status message</li><li>sending DShot commands via CLI</li></ul><h3 id="示例-2" tabindex="-1">示例 <a class="header-anchor" href="#示例-2" aria-label="Permalink to &quot;示例&quot;">​</a></h3><p>Permanently reverse motor 1:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>dshot reverse -m 1</span></span>
...
<span class="line"><span>     cold|warm|hot Specify reset type</span></span></code></pre></div><h2 id="gz-bridge" tabindex="-1">gz_bridge <a class="header-anchor" href="#gz-bridge" aria-label="Permalink to &quot;gz_bridge&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/modules/simulation/gz_bridge" target="_blank" rel="noreferrer">modules/simulation/gz_bridge</a></p><h3 id="描述-12" tabindex="-1">描述 <a class="header-anchor" href="#描述-12" aria-label="Permalink to &quot;描述&quot;">​</a></h3><h3 id="gz_bridge_usage" tabindex="-1">Usage <a class="header-anchor" href="#gz_bridge_usage" aria-label="Permalink to &quot;Usage {#gz_bridge_usage}&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>gz_bridge &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
<span class="line"><span>   start</span></span>
...
<span class="line"><span>   stop</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   status        print status info</span></span></code></pre></div><h2 id="msp-osd" tabindex="-1">msp_osd <a class="header-anchor" href="#msp-osd" aria-label="Permalink to &quot;msp_osd&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/drivers/osd/msp_osd" target="_blank" rel="noreferrer">drivers/osd/msp_osd</a></p><h3 id="描述-19" tabindex="-1">描述 <a class="header-anchor" href="#描述-19" aria-label="Permalink to &quot;描述&quot;">​</a></h3><p>MSP telemetry streamer</p><h3 id="实现-1" tabindex="-1">实现 <a class="header-anchor" href="#实现-1" aria-label="Permalink to &quot;实现&quot;">​</a></h3><p>Converts uORB messages to MSP telemetry packets</p><h3 id="示例-6" tabindex="-1">示例 <a class="header-anchor" href="#示例-6" aria-label="Permalink to &quot;示例&quot;">​</a></h3><p>CLI usage example:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>msp_osd</span></span></code></pre></div><h3 id="msp_osd_usage" tabindex="-1">Usage <a class="header-anchor" href="#msp_osd_usage" aria-label="Permalink to &quot;Usage {#msp_osd_usage}&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>msp_osd &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
<span class="line"><span>   stop</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   status        print status info</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   channel       Change VTX channel</span></span></code></pre></div><h2 id="newpixel" tabindex="-1">newpixel <a class="header-anchor" href="#newpixel" aria-label="Permalink to &quot;newpixel&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/drivers/lights/neopixel" target="_blank" rel="noreferrer">drivers/lights/neopixel</a></p><h3 id="描述-20" tabindex="-1">描述 <a class="header-anchor" href="#描述-20" aria-label="Permalink to &quot;描述&quot;">​</a></h3><p>This module is responsible for driving interfasing to the Neopixel Serial LED</p><h3 id="示例-7" tabindex="-1">示例 <a class="header-anchor" href="#示例-7" aria-label="Permalink to &quot;示例&quot;">​</a></h3><p>It is typically started with:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>neopixel -n 8</span></span></code></pre></div><p>To drive all available leds.</p><h3 id="newpixel_usage" tabindex="-1">Usage <a class="header-anchor" href="#newpixel_usage" aria-label="Permalink to &quot;Usage {#newpixel_usage}&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>newpixel &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
<span class="line"><span>   stop</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>   stop</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   status        print status info</span></span></code></pre></div><h2 id="px4io" tabindex="-1">px4io <a class="header-anchor" href="#px4io" aria-label="Permalink to &quot;px4io&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/drivers/px4io" target="_blank" rel="noreferrer">drivers/px4io</a></p><h3 id="描述-26" tabindex="-1">描述 <a class="header-anchor" href="#描述-26" aria-label="Permalink to &quot;描述&quot;">​</a></h3><p>Output driver communicating with the IO co-processor.</p><h3 id="px4io_usage" tabindex="-1">Usage <a class="header-anchor" href="#px4io_usage" aria-label="Permalink to &quot;Usage {#px4io_usage}&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>px4io &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
<span class="line"><span>   start</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>   stop</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   status        print status info</span></span></code></pre></div><h2 id="voxl-esc" tabindex="-1">voxl_esc <a class="header-anchor" href="#voxl-esc" aria-label="Permalink to &quot;voxl_esc&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/drivers/actuators/voxl_esc" target="_blank" rel="noreferrer">drivers/actuators/voxl_esc</a></p><h3 id="描述-36" tabindex="-1">描述 <a class="header-anchor" href="#描述-36" aria-label="Permalink to &quot;描述&quot;">​</a></h3><p>This module is responsible for...</p><h3 id="实现-3" tabindex="-1">实现 <a class="header-anchor" href="#实现-3" aria-label="Permalink to &quot;实现&quot;">​</a></h3><p>By default the module runs on a work queue with a callback on the uORB actuator_controls topic.</p><h3 id="示例-11" tabindex="-1">示例 <a class="header-anchor" href="#示例-11" aria-label="Permalink to &quot;示例&quot;">​</a></h3><p>It is typically started with:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>todo</span></span></code></pre></div><h3 id="voxl_esc_usage" tabindex="-1">Usage <a class="header-anchor" href="#voxl_esc_usage" aria-label="Permalink to &quot;Usage {#voxl_esc_usage}&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>voxl_esc &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
<span class="line"><span>   start         Start the task</span></span>
<span class="line"><span></span></span>
