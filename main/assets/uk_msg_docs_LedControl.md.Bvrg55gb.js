import{_ as i,c as n,a8 as a,o as t}from"./chunks/framework.BDnHobkS.js";const c=JSON.parse('{"title":"LedControl (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/LedControl.md","filePath":"uk/msg_docs/LedControl.md"}'),l={name:"uk/msg_docs/LedControl.md"};function e(p,s,h,r,o,k){return t(),n("div",null,s[0]||(s[0]=[a(`<h1 id="ledcontrol-повідомлення-uorb" tabindex="-1">LedControl (повідомлення UORB) <a class="header-anchor" href="#ledcontrol-повідомлення-uorb" aria-label="Permalink to &quot;LedControl (повідомлення UORB)&quot;">​</a></h1><p>Керування світлодіодами: керування одним чи кількома світлодіодами. Це зовнішні світлодіоди, а не світлодіоди плати</p><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/LedControl.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># LED control: control a single or multiple LED</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;s.</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uint8 ORB_QUEUE_LENGTH = 8      # needs to match BOARD_MAX_LEDS</span></span></code></pre></div>`,4)]))}const d=i(l,[["render",e]]);export{c as __pageData,d as default};
