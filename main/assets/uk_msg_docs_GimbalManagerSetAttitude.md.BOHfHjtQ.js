import{_ as i,c as a,al as n,o as t}from"./chunks/framework.D3pXwl8O.js";const g=JSON.parse('{"title":"GimbalManagerSetAttitude (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/GimbalManagerSetAttitude.md","filePath":"uk/msg_docs/GimbalManagerSetAttitude.md"}'),l={name:"uk/msg_docs/GimbalManagerSetAttitude.md"};function e(p,s,h,k,r,E){return t(),a("div",null,s[0]||(s[0]=[n(`<h1 id="gimbalmanagersetattitude-повідомлення-uorb" tabindex="-1">GimbalManagerSetAttitude (повідомлення UORB) <a class="header-anchor" href="#gimbalmanagersetattitude-повідомлення-uorb" aria-label="Permalink to &quot;GimbalManagerSetAttitude (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/GimbalManagerSetAttitude.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint64 timestamp						# time since system </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (microseconds)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint8 ORB_QUEUE_LENGTH </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 2</span></span></code></pre></div>`,3)]))}const c=i(l,[["render",e]]);export{g as __pageData,c as default};
