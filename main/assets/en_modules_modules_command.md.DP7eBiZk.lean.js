...
<span class="line"><span> Commands:</span></span>
<span class="line"><span>   query         Returns true if not existed</span></span></code></pre></div><h2 id="mtd" tabindex="-1">mtd <a class="header-anchor" href="#mtd" aria-label="Permalink to &quot;mtd&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/mtd" target="_blank" rel="noreferrer">systemcmds/mtd</a></p><p>Utility to mount and test partitions (based on FRAM/EEPROM storage as defined by the board) <a id="mtd_usage"></a></p><h3 id="usage-13" tabindex="-1">Usage <a class="header-anchor" href="#usage-13" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>mtd &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
...
<span class="line"><span>reboot</span></span></code></pre></div><p><a id="param_usage"></a></p><h3 id="usage-15" tabindex="-1">Usage <a class="header-anchor" href="#usage-15" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>param &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
...
<span class="line"><span>     &lt;param&gt;     param name</span></span></code></pre></div><h2 id="payload-deliverer" tabindex="-1">payload_deliverer <a class="header-anchor" href="#payload-deliverer" aria-label="Permalink to &quot;payload_deliverer&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/modules/payload_deliverer" target="_blank" rel="noreferrer">modules/payload_deliverer</a></p><h3 id="description-5" tabindex="-1">Description <a class="header-anchor" href="#description-5" aria-label="Permalink to &quot;Description&quot;">​</a></h3><p>Handles payload delivery with either Gripper or a Winch with an appropriate timeout / feedback sensor setting, and communicates back the delivery result as an acknowledgement internally</p><p><a id="payload_deliverer_usage"></a></p><h3 id="usage-16" tabindex="-1">Usage <a class="header-anchor" href="#usage-16" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>payload_deliverer &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>   status        print status info</span></span></code></pre></div><h2 id="perf" tabindex="-1">perf <a class="header-anchor" href="#perf" aria-label="Permalink to &quot;perf&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/perf" target="_blank" rel="noreferrer">systemcmds/perf</a></p><p>Tool to print performance counters <a id="perf_usage"></a></p><h3 id="usage-17" tabindex="-1">Usage <a class="header-anchor" href="#usage-17" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>perf [arguments...]</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span> Prints all performance counters if no arguments given</span></span></code></pre></div><h2 id="reboot" tabindex="-1">reboot <a class="header-anchor" href="#reboot" aria-label="Permalink to &quot;reboot&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/reboot" target="_blank" rel="noreferrer">systemcmds/reboot</a></p><p>Reboot the system <a id="reboot_usage"></a></p><h3 id="usage-18" tabindex="-1">Usage <a class="header-anchor" href="#usage-18" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>reboot [arguments...]</span></span>
...
<span class="line"><span>     [lock|unlock] Take/release the shutdown lock (for testing)</span></span></code></pre></div><h2 id="sd-bench" tabindex="-1">sd_bench <a class="header-anchor" href="#sd-bench" aria-label="Permalink to &quot;sd_bench&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/sd_bench" target="_blank" rel="noreferrer">systemcmds/sd_bench</a></p><p>Test the speed of an SD Card <a id="sd_bench_usage"></a></p><h3 id="usage-19" tabindex="-1">Usage <a class="header-anchor" href="#usage-19" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sd_bench [arguments...]</span></span>
...
<span class="line"><span>     [-v]        Verify data and block number</span></span></code></pre></div><h2 id="sd-stress" tabindex="-1">sd_stress <a class="header-anchor" href="#sd-stress" aria-label="Permalink to &quot;sd_stress&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/sd_stress" target="_blank" rel="noreferrer">systemcmds/sd_stress</a></p><p>Test operations on an SD Card <a id="sd_stress_usage"></a></p><h3 id="usage-20" tabindex="-1">Usage <a class="header-anchor" href="#usage-20" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sd_stress [arguments...]</span></span>
<span class="line"><span>     [-r &lt;val&gt;]  Number of runs</span></span>
<span class="line"><span>                 default: 5</span></span>
<span class="line"><span>     [-b &lt;val&gt;]  Number of bytes</span></span>
<span class="line"><span>                 default: 100</span></span></code></pre></div><h2 id="serial-passthru" tabindex="-1">serial_passthru <a class="header-anchor" href="#serial-passthru" aria-label="Permalink to &quot;serial_passthru&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/serial_passthru" target="_blank" rel="noreferrer">systemcmds/serial_passthru</a></p><p>Pass data from one device to another.</p><p>This can be used to use u-center connected to USB with a GPS on a serial port.</p><p><a id="serial_passthru_usage"></a></p><h3 id="usage-21" tabindex="-1">Usage <a class="header-anchor" href="#usage-21" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>serial_passthru [arguments...]</span></span>
...
<span class="line"><span>system_time get</span></span></code></pre></div><p><a id="system_time_usage"></a></p><h3 id="usage-22" tabindex="-1">Usage <a class="header-anchor" href="#usage-22" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>system_time &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
<span class="line"><span>   set           Set the system time, provide time in unix epoch time format</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   get           Get the system time</span></span></code></pre></div><h2 id="top" tabindex="-1">top <a class="header-anchor" href="#top" aria-label="Permalink to &quot;top&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/top" target="_blank" rel="noreferrer">systemcmds/top</a></p><p>Monitor running processes and their CPU, stack usage, priority and state <a id="top_usage"></a></p><h3 id="usage-23" tabindex="-1">Usage <a class="header-anchor" href="#usage-23" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>top [arguments...]</span></span>
<span class="line"><span>   once          print load only once</span></span></code></pre></div><h2 id="usb-connected" tabindex="-1">usb_connected <a class="header-anchor" href="#usb-connected" aria-label="Permalink to &quot;usb_connected&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/usb_connected" target="_blank" rel="noreferrer">systemcmds/usb_connected</a></p><p>Utility to check if USB is connected. Was previously used in startup scripts. A return value of 0 means USB is connected, 1 otherwise. <a id="usb_connected_usage"></a></p><h3 id="usage-24" tabindex="-1">Usage <a class="header-anchor" href="#usage-24" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>usb_connected [arguments...]</span></span></code></pre></div><h2 id="ver" tabindex="-1">ver <a class="header-anchor" href="#ver" aria-label="Permalink to &quot;ver&quot;">​</a></h2><p>Source: <a href="https://github.com/PX4/PX4-Autopilot/tree/main/src/systemcmds/ver" target="_blank" rel="noreferrer">systemcmds/ver</a></p><p>Tool to print various version information <a id="ver_usage"></a></p><h3 id="usage-25" tabindex="-1">Usage <a class="header-anchor" href="#usage-25" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>ver &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
