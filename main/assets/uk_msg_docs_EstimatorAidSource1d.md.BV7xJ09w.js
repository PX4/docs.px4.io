import{_ as i,c as a,a8 as n,o as t}from"./chunks/framework.BDnHobkS.js";const E=JSON.parse('{"title":"EstimatorAidSource1d (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/EstimatorAidSource1d.md","filePath":"uk/msg_docs/EstimatorAidSource1d.md"}'),e={name:"uk/msg_docs/EstimatorAidSource1d.md"};function l(p,s,r,h,o,k){return t(),a("div",null,s[0]||(s[0]=[n(`<h1 id="estimatoraidsource1d-повідомлення-uorb" tabindex="-1">EstimatorAidSource1d (повідомлення UORB) <a class="header-anchor" href="#estimatoraidsource1d-повідомлення-uorb" aria-label="Permalink to &quot;EstimatorAidSource1d (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/EstimatorAidSource1d.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint64 timestamp             # time since system </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (microseconds)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># TOPICS estimator_aid_src_gnss_yaw estimator_aid_src_ev_yaw</span></span></code></pre></div>`,3)]))}const c=i(e,[["render",l]]);export{E as __pageData,c as default};
