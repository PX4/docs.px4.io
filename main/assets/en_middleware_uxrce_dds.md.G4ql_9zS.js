import { _ as p } from "./chunks/architecture_xrce-dds_ros2.DdU06z7f.js";
import {
  _ as d,
  C as o,
  c,
  ...
  a as i,
  w as t,
} from "./chunks/framework.CT7RwC5a.js";
const C = JSON.parse(
    '{"title":"uXRCE-DDS (PX4-ROS 2/DDS Bridge)","description":"","frontmatter":{},"headers":[],"relativePath":"en/middleware/uxrce_dds.md","filePath":"en/middleware/uxrce_dds.md"}'
  ),
  k = { name: "en/middleware/uxrce_dds.md" };
function g(m, s, b, f, y, E) {
  const h = o("Badge"),
    n = o("tab"),
    r = o("tabs");
  return (
    ...
    c("div", null, [
      s[8] ||
        (s[8] = e(
          "h1",
          { id: "uxrce-dds-px4-ros-2-dds-bridge", tabindex: "-1" },
          [
            i("uXRCE-DDS (PX4-ROS 2/DDS Bridge) "),
            e(
              "a",
              {
                class: "header-anchor",
                href: "#uxrce-dds-px4-ros-2-dds-bridge",
                "aria-label": 'Permalink to "uXRCE-DDS (PX4-ROS 2/DDS Bridge)"',
              },
              "​"
            ),
          ],
      ...
      a(h, { type: "tip", text: "PX4 v1.14" }),
      s[9] ||
        (s[9] = l(
          '<div class="info custom-block"><p class="custom-block-title">INFO</p><p>uXRCE-DDS replaces the <a href="https://docs.px4.io/v1.13/en/middleware/micrortps.html#rtps-dds-interface-px4-fast-rtps-dds-bridge" target="_blank" rel="noreferrer">Fast-RTPS Bridge</a> used in PX4 v1.13. If you were using the Fast-RTPS Bridge, please follow the <a href="#fast-rtps-to-uxrce-dds-migration-guidelines">migration guidelines</a>.</p></div><p>PX4 uses uXRCE-DDS middleware to allow <a href="./../middleware/uorb.html">uORB messages</a> to be published and subscribed on a companion computer as though they were <a href="./../ros2/user_guide.html">ROS 2</a> topics. This provides a fast and reliable integration between PX4 and ROS 2, and makes it much easier for ROS 2 applications to get vehicle information and send commands.</p><p>PX4 uses an XRCE-DDS implementation that leverages <a href="https://micro-xrce-dds.docs.eprosima.com/en/stable/introduction.html" target="_blank" rel="noreferrer">eProsima Micro XRCE-DDS</a>.</p><p>The following guide describes the architecture and various options for setting up the client and agent. In particular it covers the options that are most important to PX4 users.</p><h2 id="architecture" tabindex="-1">Architecture <a class="header-anchor" href="#architecture" aria-label="Permalink to &quot;Architecture&quot;">​</a></h2><p>The uXRCE-DDS middleware consists of a client running on PX4 and an agent running on the companion computer, with bi-directional data exchange between them over a serial or UDP link. The agent acts as a proxy for the client, enabling it to publish and subscribe to topics in the global DDS data space.</p><p><img src="' +
            p +
            `" alt="Architecture uXRCE-DDS with ROS 2"></p><p>In order for PX4 uORB topics to be shared on the DDS network you will need <em>uXRCE-DDS client</em> running on PX4, connected to the <em>micro XRCE-DDS agent</em> running on the companion.</p><p>The PX4 <a href="./../modules/modules_system.html#uxrce-dds-client">uxrce_dds_client</a> publishes to/from a defined set of uORB topics to the global DDS data space.</p><p>The <a href="https://github.com/eProsima/Micro-XRCE-DDS-Agent" target="_blank" rel="noreferrer">eProsima micro XRCE-DDS <em>agent</em></a> runs on the companion computer and acts as a proxy for the client in the DDS/ROS 2 network.</p><p>The agent itself has no dependency on client-side code and can be built and/or installed independent of PX4 or ROS.</p><p>Code that wants to subscribe/publish to PX4 does have a dependency on client-side code; it requires uORB message definitions that match those used to create the PX4 uXRCE-DDS client so that it can interpret the messages.</p><h2 id="code-generation" tabindex="-1">Code Generation <a class="header-anchor" href="#code-generation" aria-label="Permalink to &quot;Code Generation&quot;">​</a></h2><p>The PX4 <a href="./../modules/modules_system.html#uxrce-dds-client">uxrce_dds_client</a> is generated at build time and included in PX4 firmare by default. The agent has no dependency on client code. It can be built standalone or in a ROS 2 workspace, or installed as a snap package on Ubuntu.</p><p>When PX4 is built, a code generator uses the uORB message definitions in the source tree (<a href="https://github.com/PX4/PX4-Autopilot/tree/main/msg" target="_blank" rel="noreferrer">PX4-Autopilot/msg</a>) to compile support for the subset of uORB topics in <a href="./../middleware/dds_topics.html">/src/modules/uxrce_dds_client/dds_topics.yaml</a> into <a href="./../modules/modules_system.html#uxrce-dds-client">uxrce_dds_client</a>.</p><p>PX4 main or release builds automatically export the set of uORB messages definitions in the build to an associated branch in <a href="https://github.com/PX4/px4_msgs" target="_blank" rel="noreferrer">PX4/px4_msgs</a>.</p><p>ROS 2 applications need to be built in a workspace that includes the <em>same</em> message definitions that were used to create the uXRCE-DDS client module in the PX4 Firmware. These can be included into a workspace by cloning the interface package <a href="https://github.com/PX4/px4_msgs" target="_blank" rel="noreferrer">PX4/px4_msgs</a> into your ROS 2 workspace and switching to the appropriate branch. Note that all code generation associated with the messages is handled by ROS 2.</p><h2 id="micro-xrce-dds-agent-installation" tabindex="-1">Micro XRCE-DDS Agent Installation <a class="header-anchor" href="#micro-xrce-dds-agent-installation" aria-label="Permalink to &quot;Micro XRCE-DDS Agent Installation&quot;">​</a></h2><p>The Micro XRCE-DDS Agent can be installed on the companion computer using a binary package, built and installed from source, or built and run from within a ROS 2 workspace. All of these methods fetch <em>all</em> the dependencies needed to communicate with the client (such as FastCDR).</p><div class="info custom-block"><p class="custom-block-title">INFO</p><p>The official (and more complete) installation guide is the Eprosima: <a href="https://micro-xrce-dds.docs.eprosima.com/en/latest/installation.html" target="_blank" rel="noreferrer">micro XRCE-DDS Installation Guide</a>. This section summarises the options that have been tested with PX4 during creation of these docs.</p></div><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>PX4 Micro XRCE-DDS Client is based on version <code>v2.x</code> which is not compatible with the latest <code>v3.x</code> Agent version.</p></div><h3 id="install-standalone-from-source" tabindex="-1">Install Standalone from Source <a class="header-anchor" href="#install-standalone-from-source" aria-label="Permalink to &quot;Install Standalone from Source&quot;">​</a></h3><p>On Ubuntu you can build from source and install the Agent standalone using the following commands:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> clone</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -b</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> v2.4.3</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://github.com/eProsima/Micro-XRCE-DDS-Agent.git</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ldconfig</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /usr/local/lib/</span></span></code></pre></div><div class="info custom-block"><p class="custom-block-title">INFO</p><p>There are various build configuration options linked from the corresponding topic in the <a href="https://micro-xrce-dds.docs.eprosima.com/en/latest/installation.html#installing-the-agent-standalone" target="_blank" rel="noreferrer">official guide</a>, but these have not been tested.</p></div><p>To start the agent with settings for connecting to the uXRCE-DDS client running on the simulator:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">MicroXRCEAgent</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> udp4</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 8888</span></span></code></pre></div><h3 id="install-from-snap-package" tabindex="-1">Install from Snap Package <a class="header-anchor" href="#install-from-snap-package" aria-label="Permalink to &quot;Install from Snap Package&quot;">​</a></h3><p>Install from a snap package on Ubuntu using the following command:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> snap</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> micro-xrce-dds-agent</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --edge</span></span></code></pre></div><p>To start the agent with settings for connecting to the uXRCE-DDS client running on the simulator (note that the command name is different than if you build the agent locally):</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">micro-xrce-dds-agent</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> udp4</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 8888</span></span></code></pre></div><div class="info custom-block"><p class="custom-block-title">INFO</p><p>At time of writing the stable of version installed from snap connects to PX4 but reports errors creating topics. The development version, fetched using <code>--edge</code> above, does work.</p></div><h3 id="build-run-within-ros-2-workspace" tabindex="-1">Build/Run within ROS 2 Workspace <a class="header-anchor" href="#build-run-within-ros-2-workspace" aria-label="Permalink to &quot;Build/Run within ROS 2 Workspace&quot;">​</a></h3><p>The agent can be built and launched within a ROS 2 workspace (or build standalone and launched from a workspace. You must already have installed ROS 2 following the instructions in: <a href="./../ros2/user_guide.html#install-ros-2">ROS 2 User Guide &gt; Install ROS 2</a>.</p><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>This approach will use the existing ROS 2 versions of the Agent dependencies, such as <code>fastcdr</code> and <code>fastdds</code>. This considerably speeds up the build process but requires that the Agent dependency versions match the ROS 2 ones.</p></div><p>To build the agent within ROS:</p>`,
          37
        )),
      e("ol", null, [
        s[4] ||
          (s[4] = l(
            `<li><p>Create a workspace directory for the agent:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">mkdir</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/px4_ros_uxrce_dds_ws/src</span></span></code></pre></div></li><li><p>Clone the source code for the eProsima <a href="https://github.com/eProsima/Micro-XRCE-DDS-Agent" target="_blank" rel="noreferrer">Micro-XRCE-DDS-Agent</a> to the <code>/src</code> directory (the <code>main</code> branch is cloned by default):</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">cd</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/px4_ros_uxrce_dds_ws/src</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> clone</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -b</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> v2.4.3</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://github.com/eProsima/Micro-XRCE-DDS-Agent.git</span></span></code></pre></div></li>`,
            2
          )),
        e("li", null, [
          s[2] ||
            (s[2] = e(
              ...
              [
                i(
                  "Source the ROS 2 development environment, and compile the workspace using "
                ),
                e("code", null, "colcon"),
                i(":"),
              ],
                    ...
                    () =>
                      ...
                      (s[0] = [
                        e(
                          ...
                          [
                            e("button", { title: "Copy Code", class: "copy" }),
                            e("span", { class: "lang" }, "sh"),
                            e(
                              "pre",
                              {
                                class:
...
`),
          ...
          s[3] ||
            (s[3] = e(
              ...
              null,
              [
                i("This builds all the folders under "),
                e("code", null, "/src"),
                i(" using the sourced toolchain."),
              ],
              -1
            )),
        ]),
        ...
        e("li", null, [
          s[7] ||
            (s[7] = e(
              ...
              [
                i("Source the "),
                e("code", null, "local_setup.bash"),
                i(" to make the executables available in the terminal (also "),
                e("code", null, "setup.bash"),
                i(" if using a new terminal)."),
              ],
              -1
            )),
          a(r, null, {
...
`),
      ...
      s[11] ||
        (s[11] = l(
          `<ol><li><p>Start the agent with settings for connecting to the uXRCE-DDS client running on the simulator:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">MicroXRCEAgent</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> udp4</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 8888</span></span></code></pre></div></li></ol><h2 id="starting-agent-and-client" tabindex="-1">Starting Agent and Client <a class="header-anchor" href="#starting-agent-and-client" aria-label="Permalink to &quot;Starting Agent and Client&quot;">​</a></h2><h3 id="starting-the-agent" tabindex="-1">Starting the Agent <a class="header-anchor" href="#starting-the-agent" aria-label="Permalink to &quot;Starting the Agent&quot;">​</a></h3><p>The agent is used to connect to the client over a particular channel, such as UDP or a serial connection. The channel settings are specified when the agent is started, using command line options. These are documented in the eProsima user guide: <a href="https://micro-xrce-dds.docs.eprosima.com/en/latest/agent.html#agent-cli" target="_blank" rel="noreferrer">Micro XRCE-DDS Agent &gt; Agent CLI</a>. Note that the agent supports many channel options, but PX4 only supports UDP and serial connections.</p><div class="info custom-block"><p class="custom-block-title">INFO</p><p>You should create a single instance of the agent for each channel over which you need to connect.</p></div><p>For example, the PX4 simulator runs the uXRCE-DDS client over UDP on port 8888, so to connect to the simulator you would start the agent with the command:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">MicroXRCEAgent</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> udp4</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 8888</span></span></code></pre></div><p>When working with real hardware, the setup depends on the hardware, OS, and channel. For example, if you&#39;re using the RPi <code>UART0</code> serial port, you might connect using this command (based on the information in <a href="https://www.raspberrypi.com/documentation/computers/configuration.html#configuring-uarts" target="_blank" rel="noreferrer">Raspberry Pi Documentation &gt; Configuring UARTS</a>):</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> MicroXRCEAgent</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> serial</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --dev</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /dev/AMA0</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -b</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 921600</span></span></code></pre></div><div class="info custom-block"><p class="custom-block-title">INFO</p><p>For more information about setting up communications channels see <a href="./../companion_computer/pixhawk_companion.html#serial-port-setup">Pixhawk + Companion Setup &gt; Serial Port setup</a>, and sub-documents.</p></div><h3 id="starting-the-client" tabindex="-1">Starting the Client <a class="header-anchor" href="#starting-the-client" aria-label="Permalink to &quot;Starting the Client&quot;">​</a></h3><p>The uXRCE-DDS client module (<a href="./../modules/modules_system.html#uxrce-dds-client">uxrce_dds_client</a>) is included by default in all firmware and the simulator. This must be started with appropriate settings for the communication channel that you wish to use to communicate with the agent.</p><div class="info custom-block"><p class="custom-block-title">INFO</p><p>The simulator automatically starts the client on localhost UDP port <code>8888</code> using the default uxrce-dds namespace.</p></div><p>The configuration can be done using the <a href="./../advanced_config/parameter_reference.html#uxrce-dds-client">UXRCE-DDS parameters</a>:</p><ul><li><p><a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_CFG">UXRCE_DDS_CFG</a>: Set the port to connect on, such as <code>TELEM2</code>, <code>Ethernet</code>, or <code>Wifi</code>.</p></li><li><p>If using an Ethernet connection:</p><ul><li><p><a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_PRT">UXRCE_DDS_PRT</a>: Use this to specify the agent UDP listening port. The default value is <code>8888</code>.</p></li><li><p><a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_AG_IP">UXRCE_DDS_AG_IP</a>: Use this to specify the IP address of the agent. The IP address must be provided in <code>int32</code> format as PX4 does not support string parameters. The default value is <code>2130706433</code> which corresponds to the <em>localhost</em> <code>127.0.0.1</code>.</p><p>You can use <a href="https://github.com/PX4/PX4-Autopilot/blob/main/Tools/convert_ip.py" target="_blank" rel="noreferrer">Tools/convert_ip.py</a> to convert between the formats:</p><ul><li><p>To obtain the <code>int32</code> version of an IP in decimal dot notation the command is:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">python3</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ./PX4-Autopilot/Tools/convert_ip.py</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> &lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">the</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> IP</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> address</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> in</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> decimal</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> dot</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> notatio</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">n</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span></span></code></pre></div></li><li><p>To get the IP address in decimal dot notation from the <code>int32</code> version:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">python3</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ./PX4-Autopilot/Tools/convert_ip.py</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -r</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> &lt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">the</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> IP</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> address</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> in</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> int32</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> notatio</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">n</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span></span></code></pre></div></li></ul></li></ul></li><li><p>If using a serial connection:</p><ul><li><a href="./../advanced_config/parameter_reference.html#SER_TEL2_BAUD">SER_TEL2_BAUD</a>, <a href="./../advanced_config/parameter_reference.html#SER_URT6_BAUD">SER_URT6_BAUD</a> (and so on): Use the <code>_BAUD</code> parameter associated with the serial port to set the baud rate. For example, you&#39;d set a value for <code>SER_TEL2_BAUD</code> if you are connecting to the companion using <code>TELEM2</code>. For more information see <a href="./../peripherals/serial_configuration.html#serial-port-configuration">Serial port configuration</a>.</li></ul></li><li><p>Some setups might also need these parameters to be set:</p><ul><li><a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_KEY">UXRCE_DDS_KEY</a>: The uXRCE-DDS key. If you&#39;re working in a multi-client, single agent configuration, each client should have a unique non-zero key. This is primarily important for multi-vehicle simulations, where all clients are connected in UDP to the same agent. (See the <a href="https://micro-xrce-dds.docs.eprosima.com/en/stable/client_api.html#session" target="_blank" rel="noreferrer">official eprosima documentation</a> , <code>uxr_init_session</code>.)</li><li><a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_DOM_ID">UXRCE_DDS_DOM_ID</a>: The DDS domain ID. This provides a logical separation between DDS networks, and can be used to separate clients on different networks. By default, ROS 2 operates on ID 0.</li><li><a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_PTCFG">UXRCE_DDS_PTCFG</a>: uXRCE-DDS participant configuration. It allows to restrict the visibility of the DDS topics to the <em>localhost</em> only and to use user-customized participant configuration files stored on the agent side.</li><li><a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_SYNCT">UXRCE_DDS_SYNCT</a>: Bridge time synchronization enable. The uXRCE-DDS client module can synchronize the timestamp of the messages exchanged over the bridge. This is the default configuration. In certain situations, for example during <a href="./../ros2/user_guide.html#ros-gazebo-and-px4-time-synchronization">simulations</a>, this feature may be disabled.</li></ul></li></ul><div class="info custom-block"><p class="custom-block-title">INFO</p><p>Many ports are already have a default configuration. To use these ports you must first disable the existing configuration:</p><ul><li><code>TELEM1</code> and <code>TELEM2</code> are set up by default to connect via MAVLink to a GCS and a companion computer (respectively). Disable by setting <a href="./../advanced_config/parameter_reference.html#MAV_0_CONFIG">MAV_0_CONFIG=0</a> or <a href="./../advanced_config/parameter_reference.html#MAV_1_CONFIG">MAV_1_CONFIG=0</a> to zero. See <a href="./../peripherals/mavlink_peripherals.html">MAVLink Peripherals</a> for more information.</li><li>Other ports can similarly be configured. See <a href="./../peripherals/serial_configuration.html#serial-port-configuration">Serial port configuration</a>.</li></ul></div><p>Once set, you may need to reboot PX4 for the parameters to take effect. They will then persist through subsequent reboots.</p><p>You can also start the <a href="./../modules/modules_system.html#uxrce-dds-client">uxrce_dds_client</a> using a command line. This can be called as part of <a href="./../concept/system_startup.html">System Startup</a> or through the <a href="./../debug/mavlink_shell.html">MAVLink Shell</a> (or a system console). This method is useful when you need to set a custom client namespace, as no parameter is provided for this purpose. For example, the following command can be used to connect via Ethernet to a remote host at <code>192.168.0.100:8888</code> and to set the client namespace to <code>/drone/</code>.</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">uxrce_dds_client</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> start</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -t</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> udp</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 8888</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -h</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 192.168.0.100</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -n</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> drone</span></span></code></pre></div><p>Options <code>-p</code> or <code>-h</code> are used to bypass <code>UXRCE_DDS_PRT</code> and <code>UXRCE_DDS_AG_IP</code>.</p><h4 id="starting-the-client-in-simulation" tabindex="-1">Starting the Client in Simulation <a class="header-anchor" href="#starting-the-client-in-simulation" aria-label="Permalink to &quot;Starting the Client in Simulation&quot;">​</a></h4><p>The simulator <a href="./../concept/system_startup.html">startup logic</a> (<a href="https://github.com/PX4/PX4-Autopilot/blob/main/ROMFS/px4fmu_common/init.d-posix/rcS" target="_blank" rel="noreferrer">init.d-posix/rcS</a>) uses the client startup commands for single and <a href="./../ros2/multi_vehicle.html">multi vehicle simulations</a>, enabling the setting of appropriate instance ids and DDS namespaces. By default the client is started on localhost UDP port <code>8888</code> with no additional namespace.</p><p>Environment variables are provided that override some <a href="./../advanced_config/parameter_reference.html#uxrce-dds-client">UXRCE-DDS parameters</a>. These allow users to create custom startup files for their simulations:</p><ul><li><code>PX4_UXRCE_DDS_NS</code>: Use this to specify the topic <a href="#customizing-the-namespace">namespace</a>).</li><li><code>ROS_DOMAIN_ID</code>: Use this to replace <a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_DOM_ID">UXRCE_DDS_DOM_ID</a>.</li><li><code>PX4_UXRCE_DDS_PORT</code>: Use this to replace <a href="./../advanced_config/parameter_reference.html#UXRCE_DDS_PRT">UXRCE_DDS_PRT</a>.</li></ul><p>For example, the following command can be used to start a Gazebo simulation with che client operating on the DDS domain <code>3</code>, port <code>9999</code> and topic namespace <code>drone</code>.</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">ROS_DOMAIN_ID</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">3</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> PX4_UXRCE_DDS_PORT</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">9999</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> PX4_UXRCE_DDS_NS</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">drone</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> make</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> px4_sitl</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> gz_x500</span></span></code></pre></div><h2 id="supported-uorb-messages" tabindex="-1">Supported uORB Messages <a class="header-anchor" href="#supported-uorb-messages" aria-label="Permalink to &quot;Supported uORB Messages&quot;">​</a></h2><p>The set of <a href="./../msg_docs/">PX4 uORB topics</a> that are exposed through the client are set in <a href="./../middleware/dds_topics.html">dds_topics.yaml</a>.</p><p>The topics are release specific (support is compiled into <a href="./../modules/modules_system.html#uxrce-dds-client">uxrce_dds_client</a> at build time). While most releases should support a very similar set of messages, to be certain you would need to check the yaml file for your particular release.</p><p>Note that ROS 2/DDS needs to have the <em>same</em> message definitions that were used to create the uXRCE-DDS client module in the PX4 Firmware in order to interpret the messages. The message definitions are stored in the ROS 2 interface package <a href="https://github.com/PX4/px4_msgs" target="_blank" rel="noreferrer">PX4/px4_msgs</a>, and they are automatically synchronized by CI on the <code>main</code> and release branches. Note that all the messages from PX4 source code are present in the repository, but only those listed in <code>dds_topics.yaml</code> will be available as ROS 2 topics. Therefore,</p><ul><li><p>If you&#39;re using a main or release version of PX4 you can get the message definitions by cloning the interface package <a href="https://github.com/PX4/px4_msgs" target="_blank" rel="noreferrer">PX4/px4_msgs</a> into your workspace.</p></li><li><p>If you&#39;re creating or modifying uORB messages you must manually update the messages in your workspace from your PX4 source tree. Generally this means that you would update <a href="https://github.com/PX4/PX4-Autopilot/blob/main/src/modules/uxrce_dds_client/dds_topics.yaml" target="_blank" rel="noreferrer">dds_topics.yaml</a>, clone the interface package, and then manually synchronize it by copying the new/modified message definitions from <a href="https://github.com/PX4/PX4-Autopilot/tree/main/msg" target="_blank" rel="noreferrer">PX4-Autopilot/msg</a> to its <code>msg</code> folders. Assuming that PX4-Autopilot is in your home directory <code>~</code>, while <code>px4_msgs</code> is in <code>~/px4_ros_com/src/</code>, then the command might be:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">rm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/px4_ros_com/src/px4_msgs/msg/</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">*</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">.msg</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">cp</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/PX4-Autopilot/msg/</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">*</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">.msg</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/px4_ros_com/src/px4_msgs/msg/</span></span></code></pre></div><div class="info custom-block"><p class="custom-block-title">INFO</p><p>Technically, <a href="./../middleware/dds_topics.html">dds_topics.yaml</a> completely defines the relationship between PX4 uORB topics and ROS 2 messages. For more information see <a href="#dds-topics-yaml">DDS Topics YAML</a> below.</p></div></li></ul><h2 id="customizing-the-namespace" tabindex="-1">Customizing the Namespace <a class="header-anchor" href="#customizing-the-namespace" aria-label="Permalink to &quot;Customizing the Namespace&quot;">​</a></h2><p>Custom topic and service namespaces can be applied at build time (changing <a href="./../middleware/dds_topics.html">dds_topics.yaml</a>) or at runtime (which is useful for multi vehicle operations):</p><ul><li>One possibility is to use the <code>-n</code> option when starting the <a href="./../modules/modules_system.html#uxrce-dds-client">uxrce_dds_client</a> from command line. This technique can be used both in simulation and real vehicles.</li><li>A custom namespace can be provided for simulations (only) by setting the environment variable <code>PX4_UXRCE_DDS_NS</code> before starting the simulation.</li></ul><div class="info custom-block"><p class="custom-block-title">INFO</p><p>Changing the namespace at runtime will append the desired namespace as a prefix to all <code>topic</code> fields in <a href="./../middleware/dds_topics.html">dds_topics.yaml</a> and all <a href="#dds-ros-2-services">service servers</a>. Therefore, commands like:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">uxrce_dds_client</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> start</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -n</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> uav_1</span></span></code></pre></div><p>or</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">PX4_UXRCE_DDS_NS</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uav_1</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> make</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> px4_sitl</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> gz_x500</span></span></code></pre></div><p>will generate topics under the namespaces:</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/uav_1/fmu/in/</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # for subscribers</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/uav_1/fmu/out/</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> # for publishers</span></span></code></pre></div></div><h2 id="px4-ros-2-qos-settings" tabindex="-1">PX4 ROS 2 QoS Settings <a class="header-anchor" href="#px4-ros-2-qos-settings" aria-label="Permalink to &quot;PX4 ROS 2 QoS Settings&quot;">​</a></h2><p>PX4 QoS settings for publishers are incompatible with the default QoS settings for ROS 2 subscribers. So if ROS 2 code needs to subscribe to a uORB topic, it will need to use compatible QoS settings. One example of which is shown in <a href="./../ros2/user_guide.html#ros-2-subscriber-qos-settings">ROS 2 User Guide &gt; ROS 2 Subscriber QoS Settings</a>.</p><p>PX4 uses the following QoS settings for publishers:</p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">uxrQoS_t</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> qos </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre></div><p>PX4 uses the following QoS settings for subscribers:</p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">uxrQoS_t</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> qos </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre></div><p>ROS 2 uses the following QoS settings (by default) for publishers and subscriptions: &quot;keep last&quot; for history with a queue size of 10, &quot;reliable&quot; for reliability, &quot;volatile&quot; for durability, and &quot;system default&quot; for liveliness. Deadline, lifespan, and lease durations are also all set to &quot;default&quot;.</p><h2 id="dds-topics-yaml" tabindex="-1">DDS Topics YAML <a class="header-anchor" href="#dds-topics-yaml" aria-label="Permalink to &quot;DDS Topics YAML&quot;">​</a></h2><p>The PX4 <a href="./../middleware/dds_topics.html">dds_topics.yaml</a> file defines the set of PX4 uORB topics that are built into firmware and published. More precisely, it completely defines the relationship/pairing between PX4 uORB and ROS 2 messages.</p><p>The file is structured as follows:</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">publications</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    rate_limit</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">50.</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # Limit max publication rate to 50 Hz</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # Use default publication rate limit of 100 Hz</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    rate_limit</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">5.</span></span>
<span class="line"></span>
