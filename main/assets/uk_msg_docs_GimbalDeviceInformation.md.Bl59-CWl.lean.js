import{_ as i,c as a,a8 as n,o as l}from"./chunks/framework.BDnHobkS.js";const _=JSON.parse('{"title":"GimbalDeviceInformation (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/GimbalDeviceInformation.md","filePath":"uk/msg_docs/GimbalDeviceInformation.md"}'),t={name:"uk/msg_docs/GimbalDeviceInformation.md"};function p(h,s,k,e,E,r){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="gimbaldeviceinformation-повідомлення-uorb" tabindex="-1">GimbalDeviceInformation (повідомлення UORB) <a class="header-anchor" href="#gimbaldeviceinformation-повідомлення-uorb" aria-label="Permalink to &quot;GimbalDeviceInformation (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/GimbalDeviceInformation.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint64 timestamp						# time since system </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (microseconds)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint8 gimbal_device_id</span></span></code></pre></div>`,3)]))}const c=i(t,[["render",p]]);export{_ as __pageData,c as default};
