...
</code></pre><p><a id="sagetech_mxs_usage"></a></p><h3 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sagetech_mxs &lt;command&gt; [arguments...]</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>   squawk        Set the Squawk Code. [0-7777] Octal (no digit larger than 7)</span></span></code></pre></div>`,7)]))}const g=a(r,[["render",p]]);export{m as __pageData,g as default};
