import{_ as i,c as a,o as n,al as e}from"./chunks/framework.CT7RwC5a.js";const d=JSON.parse('{"title":"ArmingCheckReplyV0 (UORB message)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/ArmingCheckReplyV0.md","filePath":"uk/msg_docs/ArmingCheckReplyV0.md"}'),l={name:"uk/msg_docs/ArmingCheckReplyV0.md"};function p(t,s,h,k,r,o){return n(),a("div",null,s[0]||(s[0]=[e(`<h1 id="armingcheckreplyv0-uorb-message" tabindex="-1">ArmingCheckReplyV0 (UORB message) <a class="header-anchor" href="#armingcheckreplyv0-uorb-message" aria-label="Permalink to &quot;ArmingCheckReplyV0 (UORB message)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/px4_msgs_old/msg/ArmingCheckReplyV0.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint32 MESSAGE_VERSION </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">EventV0[5] events</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uint8 ORB_QUEUE_LENGTH = 4</span></span></code></pre></div>`,3)]))}const _=i(l,[["render",p]]);export{d as __pageData,_ as default};
