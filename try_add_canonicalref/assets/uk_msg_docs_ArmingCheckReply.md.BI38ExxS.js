import{_ as i,c as n,al as a,o as l}from"./chunks/framework.ByhWQ_D0.js";const d=JSON.parse('{"title":"ArmingCheckReply (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/ArmingCheckReply.md","filePath":"uk/msg_docs/ArmingCheckReply.md"}'),e={name:"uk/msg_docs/ArmingCheckReply.md"};function p(t,s,h,k,r,o){return l(),n("div",null,s[0]||(s[0]=[a(`<h1 id="armingcheckreply-повідомлення-uorb" tabindex="-1">ArmingCheckReply (повідомлення UORB) <a class="header-anchor" href="#armingcheckreply-повідомлення-uorb" aria-label="Permalink to &quot;ArmingCheckReply (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/versioned/ArmingCheckReply.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint32 MESSAGE_VERSION </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0</span></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uint8 ORB_QUEUE_LENGTH = 4</span></span></code></pre></div>`,3)]))}const E=i(e,[["render",p]]);export{d as __pageData,E as default};
