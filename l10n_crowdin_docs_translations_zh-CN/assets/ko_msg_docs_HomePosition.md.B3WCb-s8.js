import{_ as i,c as a,o as n,al as t}from"./chunks/framework.D8UyiDWg.js";const d=JSON.parse('{"title":"HomePosition (UORB message)","description":"","frontmatter":{},"headers":[],"relativePath":"ko/msg_docs/HomePosition.md","filePath":"ko/msg_docs/HomePosition.md"}'),e={name:"ko/msg_docs/HomePosition.md"};function l(p,s,h,o,k,E){return n(),a("div",null,s[0]||(s[0]=[t(`<h1 id="homeposition-uorb-message" tabindex="-1">HomePosition (UORB message) <a class="header-anchor" href="#homeposition-uorb-message" aria-label="Permalink to &quot;HomePosition (UORB message)&quot;">​</a></h1><p>GPS home position in WGS84 coordinates.</p><p><a href="https://github.com/PX4/PX4-Autopilot/blob/main/msg/versioned/HomePosition.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># GPS home position in WGS84 coordinates.</span></span>
