import{_ as s,c as a,o as i,ab as n}from"./chunks/framework.CUflZczI.js";const _=JSON.parse('{"title":"GimbalManagerSetAttitude (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/GimbalManagerSetAttitude.md","filePath":"uk/msg_docs/GimbalManagerSetAttitude.md"}'),t={name:"uk/msg_docs/GimbalManagerSetAttitude.md"},e=n(`<h1 id="gimbalmanagersetattitude-повідомлення-uorb" tabindex="-1">GimbalManagerSetAttitude (повідомлення UORB) <a class="header-anchor" href="#gimbalmanagersetattitude-повідомлення-uorb" aria-label="Permalink to &quot;GimbalManagerSetAttitude (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/release/1.15/msg/GimbalManagerSetAttitude.msg" target="_blank" rel="noreferrer">вихідний файл</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint64 timestamp                        # time since system </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (microseconds)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">float32 angular_velocity_z</span></span></code></pre></div>`,3),l=[e];function p(h,k,r,E,d,c){return i(),a("div",null,l)}const o=s(t,[["render",p]]);export{_ as __pageData,o as default};
