import{_ as s,c as i,o as a,ab as n}from"./chunks/framework.CUflZczI.js";const E=JSON.parse('{"title":"AutotuneAttitudeControlStatus (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/AutotuneAttitudeControlStatus.md","filePath":"uk/msg_docs/AutotuneAttitudeControlStatus.md"}'),t={name:"uk/msg_docs/AutotuneAttitudeControlStatus.md"},l=n(`<h1 id="autotuneattitudecontrolstatus-повідомлення-uorb" tabindex="-1">AutotuneAttitudeControlStatus (повідомлення UORB) <a class="header-anchor" href="#autotuneattitudecontrolstatus-повідомлення-uorb" aria-label="Permalink to &quot;AutotuneAttitudeControlStatus (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/release/1.15/msg/AutotuneAttitudeControlStatus.msg" target="_blank" rel="noreferrer">вихідний файл</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint64 timestamp                # time since system </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (microseconds)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uint8 state</span></span></code></pre></div>`,3),e=[l];function p(h,k,o,r,F,d){return a(),i("div",null,e)}const u=s(t,[["render",p]]);export{E as __pageData,u as default};
