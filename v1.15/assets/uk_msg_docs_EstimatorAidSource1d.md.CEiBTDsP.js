import{_ as s,c as a,o as i,ab as n}from"./chunks/framework.CUflZczI.js";const _=JSON.parse('{"title":"EstimatorAidSource1d (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/EstimatorAidSource1d.md","filePath":"uk/msg_docs/EstimatorAidSource1d.md"}'),t={name:"uk/msg_docs/EstimatorAidSource1d.md"},e=n(`<h1 id="estimatoraidsource1d-повідомлення-uorb" tabindex="-1">EstimatorAidSource1d (повідомлення UORB) <a class="header-anchor" href="#estimatoraidsource1d-повідомлення-uorb" aria-label="Permalink to &quot;EstimatorAidSource1d (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/release/1.15/msg/EstimatorAidSource1d.msg" target="_blank" rel="noreferrer">вихідний файл</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint64 timestamp             # time since system </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (microseconds)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># TOPICS estimator_aid_src_gnss_yaw estimator_aid_src_ev_yaw</span></span></code></pre></div>`,3),l=[e];function p(r,h,o,k,d,E){return i(),a("div",null,l)}const g=s(t,[["render",p]]);export{_ as __pageData,g as default};
