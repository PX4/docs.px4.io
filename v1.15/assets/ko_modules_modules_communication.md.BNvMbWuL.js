import{_ as a,c as s,o as n,ab as e}from"./chunks/framework.CUflZczI.js";const v=JSON.parse('{"title":"모듈 참조: 통신","description":"","frontmatter":{},"headers":[],"relativePath":"ko/modules/modules_communication.md","filePath":"ko/modules/modules_communication.md"}'),l={name:"ko/modules/modules_communication.md"},t=e(`<h1 id="모듈-참조-통신" tabindex="-1">모듈 참조: 통신 <a class="header-anchor" href="#모듈-참조-통신" aria-label="Permalink to &quot;모듈 참조: 통신&quot;">​</a></h1><h2 id="frsky-telemetry" tabindex="-1">frsky_telemetry <a class="header-anchor" href="#frsky-telemetry" aria-label="Permalink to &quot;frsky_telemetry&quot;">​</a></h2><p>소스: <a href="https://github.com/PX4/PX4-Autopilot/tree/master/src/drivers/telemetry/frsky_telemetry" target="_blank" rel="noreferrer">drivers/telemetry/frsky_telemetry</a></p><p>FrSky 텔레메트리를 지원합니다. D 또는 S.PORT 프로토콜을 자동으로 감지합니다. <a id="frsky_telemetry_usage"></a></p><h3 id="사용법" tabindex="-1">사용법 <a class="header-anchor" href="#사용법" aria-label="Permalink to &quot;사용법&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>frsky_telemetry &lt;command&gt; [arguments...]</span></span>
...
<span class="line"><span>                 auto</span></span></code></pre></div><h2 id="mavlink" tabindex="-1">mavlink <a class="header-anchor" href="#mavlink" aria-label="Permalink to &quot;mavlink&quot;">​</a></h2><p>소스: <a href="https://github.com/PX4/PX4-Autopilot/tree/master/src/modules/mavlink" target="_blank" rel="noreferrer">modules/mavlink</a></p><h3 id="설명" tabindex="-1">설명 <a class="header-anchor" href="#설명" aria-label="Permalink to &quot;설명&quot;">​</a></h3><p>이 모듈은 직렬 링크 또는 UDP 네트워크에서 사용할 수 있는 MAVLink 프로토콜을 구현합니다. uORB로 시스템과 통신합니다. 일부 메시지는 모듈에서 직접 처리되고(예: 임무 프로토콜), 다른 메시지는 uORB를 통하여 게시됩니다(예: vehicle_command).</p><p>스트림은 차량 자세와 같은 특정 속도로 주기적 메시지를 전송합니다. mavlink 인스턴스를 시작시에 활성화된 스트림 세트를 속도와 함께 정의하는 모드를 지정할 수 있습니다. 실행 중인 인스턴스의 경우 <code>mavlink stream</code> 명령어를 통하여 스트림을 설정할 수 있습니다.</p><p>하나의 직렬 장치 또는 네트워크 포트에 각각 연결된 모듈의 여러 독립 인스턴스가 있을 수 있습니다.</p><h3 id="구현" tabindex="-1">구현 <a class="header-anchor" href="#구현" aria-label="Permalink to &quot;구현&quot;">​</a></h3><p>구현은 송신 및 수신 스레드의 2개 스레드를 사용합니다. 전송자는 고정된 속도로 실행되며, 결합된 대역폭이 설정된 속도(<code>-r</code>)보다 높거나 물리적 링크가 포화된 경우 스트림의 속도를 동적으로 줄입니다. 이것은 <code>mavlink status</code>로 확인할 수 있습니다. <code>rate mult</code>가 1보다 작은 지 확인하십시오.</p><p><strong>주의</strong>: 일부 데이터는 두 스레드에서 모두 액세스 및 수정되므로 코드를 변경하거나, 기능을 확장시에 경쟁 조건과 데이터 손상을 방지하기 위하여 이를 고려하여야 합니다.</p><h3 id="예" tabindex="-1">예 <a class="header-anchor" href="#예" aria-label="Permalink to &quot;예&quot;">​</a></h3><p>전송 속도가 921600이고, 최대 전송 속도가 80kB/s인 ttyS1 직렬 포트에서 mavlink를 시작합니다.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>mavlink start -d /dev/ttyS1 -b 921600 -m onboard -r 80000</span></span></code></pre></div><p>UDP 포트 14556에서 mavlink를 시작하고, 50Hz로 HIGHRES_IMU 메시지를 활성화합니다.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>mavlink start -u 14556 -r 1000000</span></span>
...
<span class="line"><span>                 startup script.</span></span></code></pre></div><h2 id="uorb" tabindex="-1">uorb <a class="header-anchor" href="#uorb" aria-label="Permalink to &quot;uorb&quot;">​</a></h2><p>소스: <a href="https://github.com/PX4/PX4-Autopilot/tree/master/src/systemcmds/uorb" target="_blank" rel="noreferrer">systemcmds/uorb</a></p><h3 id="설명-1" tabindex="-1">설명 <a class="header-anchor" href="#설명-1" aria-label="Permalink to &quot;설명&quot;">​</a></h3><p>uORB는 모듈 간의 통신에 사용되는 내부 pub-sub 메시징 시스템입니다.</p><h3 id="구현-1" tabindex="-1">구현 <a class="header-anchor" href="#구현-1" aria-label="Permalink to &quot;구현&quot;">​</a></h3><p>구현은 비동기식이며 잠금이 없습니다. 게시자는 구독자를 기다리지 않으며, 그 반대도 마찬가지입니다. 이것은 발행자와 구독자 사이에 별도의 버퍼를 가짐으로써 달성됩니다.</p><p>코드는 메모리 공간과 메시지 교환 대기 시간을 최소화하도록 최적화되었습니다.</p><p>메시지는 <code>/msg</code> 디렉토리에 정의됩니다. 빌드 타임에 C/C++ 코드로 변환됩니다.</p><p>ORB_USE_PUBLISHER_RULES로 컴파일하면, uORB 게시 규칙이 있는 파일을 사용하여, 어떤 모듈이 어떤 주제를 게시할 수 있는 지 설정할 수 있습니다. 이것은 시스템 전체 재생에 사용됩니다.</p><h3 id="예-1" tabindex="-1">예 <a class="header-anchor" href="#예-1" aria-label="Permalink to &quot;예&quot;">​</a></h3><p>주제 게시 비율을 모니터링합니다. <code>top</code> 외에 일반 시스템 검사를 위한 중요한 명령어입니다.</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>uorb top</span></span></code></pre></div><p><a id="uorb_usage"></a></p><h3 id="사용법-2" tabindex="-1">사용법 <a class="header-anchor" href="#사용법-2" aria-label="Permalink to &quot;사용법&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>uorb &lt;command&gt; [arguments...]</span></span>
<span class="line"><span> Commands:</span></span>
...
<span class="line"><span>     [&lt;filter1&gt; [&lt;filter2&gt;]] topic(s) to match (implies -a)</span></span></code></pre></div>`,38),p=[t];function i(o,r,c,d,u,m){return n(),s("div",null,p)}const g=a(l,[["render",i]]);export{v as __pageData,g as default};
