import{_ as s,c as a,o as t,ab as e}from"./chunks/framework.CUflZczI.js";const E=JSON.parse('{"title":"RadioStatus (UORB message)","description":"","frontmatter":{},"headers":[],"relativePath":"en/msg_docs/RadioStatus.md","filePath":"en/msg_docs/RadioStatus.md"}'),i={name:"en/msg_docs/RadioStatus.md"},n=e(`<h1 id="radiostatus-uorb-message" tabindex="-1">RadioStatus (UORB message) <a class="header-anchor" href="#radiostatus-uorb-message" aria-label="Permalink to &quot;RadioStatus (UORB message)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/release/1.15/msg/RadioStatus.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint16 fix				# count of error corrected packets</span></span></code></pre></div>`,3),l=[n];function r(o,p,c,h,d,u){return t(),a("div",null,l)}const g=s(i,[["render",r]]);export{E as __pageData,g as default};
