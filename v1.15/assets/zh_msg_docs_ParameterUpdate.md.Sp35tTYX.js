import{_ as s,c as a,o as e,ab as t}from"./chunks/framework.CUflZczI.js";const m=JSON.parse('{"title":"ParameterUpdate (UORB message)","description":"","frontmatter":{},"headers":[],"relativePath":"zh/msg_docs/ParameterUpdate.md","filePath":"zh/msg_docs/ParameterUpdate.md"}'),n={name:"zh/msg_docs/ParameterUpdate.md"},i=t(`<h1 id="parameterupdate-uorb-message" tabindex="-1">ParameterUpdate (UORB message) <a class="header-anchor" href="#parameterupdate-uorb-message" aria-label="Permalink to &quot;ParameterUpdate (UORB message)&quot;">​</a></h1><p>This message is used to notify the system about one or more parameter changes</p><p><a href="https://github.com/PX4/PX4-Autopilot/blob/release/1.15/msg/ParameterUpdate.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># This message is used to notify the system about one or more parameter changes</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint16 custom_default</span></span></code></pre></div>`,4),p=[i];function l(r,h,c,o,d,E){return e(),a("div",null,p)}const g=s(n,[["render",l]]);export{m as __pageData,g as default};
