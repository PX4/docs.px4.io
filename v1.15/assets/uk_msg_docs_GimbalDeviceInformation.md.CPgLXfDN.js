import{_ as s,c as i,o as a,ab as n}from"./chunks/framework.CUflZczI.js";const g=JSON.parse('{"title":"GimbalDeviceInformation (повідомлення UORB)","description":"","frontmatter":{},"headers":[],"relativePath":"uk/msg_docs/GimbalDeviceInformation.md","filePath":"uk/msg_docs/GimbalDeviceInformation.md"}'),l={name:"uk/msg_docs/GimbalDeviceInformation.md"},t=n(`<h1 id="gimbaldeviceinformation-повідомлення-uorb" tabindex="-1">GimbalDeviceInformation (повідомлення UORB) <a class="header-anchor" href="#gimbaldeviceinformation-повідомлення-uorb" aria-label="Permalink to &quot;GimbalDeviceInformation (повідомлення UORB)&quot;">​</a></h1><p><a href="https://github.com/PX4/PX4-Autopilot/blob/release/1.15/msg/GimbalDeviceInformation.msg" target="_blank" rel="noreferrer">вихідний файл</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint64 timestamp                        # time since system </span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (microseconds)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">uint8 gimbal_device_compid</span></span></code></pre></div>`,3),p=[t];function h(k,e,E,r,_,d){return a(),i("div",null,p)}const o=s(l,[["render",h]]);export{g as __pageData,o as default};
