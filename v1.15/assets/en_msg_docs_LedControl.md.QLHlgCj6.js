import{_ as s,c as n,o as i,ab as a}from"./chunks/framework.CUflZczI.js";const E=JSON.parse('{"title":"LedControl (UORB message)","description":"","frontmatter":{},"headers":[],"relativePath":"en/msg_docs/LedControl.md","filePath":"en/msg_docs/LedControl.md"}'),e={name:"en/msg_docs/LedControl.md"},t=a(`<h1 id="ledcontrol-uorb-message" tabindex="-1">LedControl (UORB message) <a class="header-anchor" href="#ledcontrol-uorb-message" aria-label="Permalink to &quot;LedControl (UORB message)&quot;">​</a></h1><p>LED control: control a single or multiple LED&#39;s. These are the externally visible LED&#39;s, not the board LED&#39;s</p><p><a href="https://github.com/PX4/PX4-Autopilot/blob/release/1.15/msg/LedControl.msg" target="_blank" rel="noreferrer">source file</a></p><div class="language-c vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">c</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># LED control: control a single or multiple LED</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;s.</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">uint8 ORB_QUEUE_LENGTH = 8      # needs to match BOARD_MAX_LEDS</span></span></code></pre></div>`,4),l=[t];function p(h,r,o,k,F,c){return i(),n("div",null,l)}const _=s(e,[["render",p]]);export{E as __pageData,_ as default};
